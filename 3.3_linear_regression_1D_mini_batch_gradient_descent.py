...
# customize the weight and bias (so pytorch takes longer to converge, for the sake of example)
model.state_dict()['linear1.weight'][0] = -15
model.state_dict()['linear1.bias'][0] = -10
